...
counts = pd.read_csv('/root/stVAT_master/data/mel1_rep2/counts.csv',index_col=0)  
counts=counts.T
coords = pd.read_csv('/root/stVAT_master/data/mel1_rep2/coords.csv', index_col=0)
...
imputed_adata = stVAT(
    adata=adata,
    test_3D_data=test_3D_data,
    integral_coords=integral_coords,
    position_info=position_info,
    train_lr=train_lr,
    train_hr=train_hr,
    in_tissue_matrix=in_tissue_matrix,
    input_dim=None,
    patch_size=8,
    batch_size=512,
    vae_hidden_dim=32,
